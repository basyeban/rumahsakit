...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <nav aria-label="breadcrumb">
                    <h2 class="page-title">erorr page</h2>
    ...
    <!-- 404 area -->
    <div class="error-area padding-top-110 padding-bottom-90">
        <div class="container d-flex align-items-center justify-content-center">
            <div class="error-wrapper text-center">
                <div class="error-title margin-bottom-50">
                    <h2 class="wow fadeInUp">Oops... Page Not Found</h2>
                </div>
                <div class="error-img">
                    <img src="assets/images/404.png" alt="">
                </div>
                <div class="error-btn margin-top-60">
                    <a href="index.php" class="btn1 wow fadeInUp">back to home</a>
                </div>
            </div>
        </div>
    </div>
