...
<!-- Mirrored from shreyu.coderthemes.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jan 2024 11:11:02 GMT -->
            ...
            <div class="container-fluid">
                ...
                <div class="logo-box">
                    <a href="index.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="admin-template/assets/images/icon.png" alt="" height="10">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <span class="text-muted text-uppercase fs-12 fw-bold">Our Services</span>
                                            <h3 class="mb-0">10</h3>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <span class="text-muted text-uppercase fs-12 fw-bold">Total Doctors</span>
                                            <h3 class="mb-0">11</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i data-feather="users"></i>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <span class="text-muted text-uppercase fs-12 fw-bold">Today Appointments</span>
                                            <h3 class="mb-0">11</h3>
                                        </div>
                                        <div class="align-self-center">
                                            <i data-feather="file-text"></i>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <span class="text-muted text-uppercase fs-12 fw-bold">Today Customers Contact</span>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    ...
                                    <div class="d-flex p-3 border-bottom">
                                        <div class="flex-grow-1">
                                            <h4 class="mt-0 mb-1 fs-22">121,000</h4>
                                            <span class="text-muted">Last 7 Days Visitors</span>
                                        </div>
                                        <i data-feather="users" class="align-self-center icon-dual icon-md"></i>
                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title mt-0 mb-0 header-title">User Appointments</h5>
